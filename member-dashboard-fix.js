...
function loadSecurityCenter(){if(document.getElementById('hfSecurityCenter'))return;const s=document.createElement('script');s.src='member-security-center.js?v=20260911-3';s.async=false;document.head.appendChild(s);}
