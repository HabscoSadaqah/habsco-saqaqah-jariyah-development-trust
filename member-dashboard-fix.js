...
function clean(){
  const hide=['.hero p','.balance-card .helper','.app-card span','.loan-card p','.footer-note','.hf-admin-panel p','.hf-admin-note','.hf-savings-note','.hf-savings-eyebrow','.hf-savings-head p','.hf-savings-months'];
  ...
  document.querySelectorAll('.footer-note').forEach(e=>e.remove());
}
