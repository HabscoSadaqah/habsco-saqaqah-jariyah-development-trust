(()=>{
  ...
  const loadPinRefreshFix=()=>{if(document.querySelector('script[data-hf-pin-refresh-fix]'))return;const s=document.createElement('script');s.src='pin-refresh-fix.js?v=20260913-1';s.async=false;s.dataset.hfPinRefreshFix='1';document.head.appendChild(s)};
