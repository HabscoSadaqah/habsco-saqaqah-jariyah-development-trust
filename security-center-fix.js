(()=>{
  ...
  const loadSavingsPinFix=()=>{if(document.querySelector('script[data-hf-savings-pin-fix]')||document.getElementById('hf-pin-board-fix-style'))return;const s=document.createElement('script');s.src='pin-board-fix.js?v=20260913-3';s.async=false;s.dataset.hfSavingsPinFix='1';document.head.appendChild(s)};
