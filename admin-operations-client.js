...
const loadWalletFix=()=>{if(document.getElementById('hfAdminWalletFix'))return;const s=document.createElement('script');s.id='hfAdminWalletFix';s.src='admin-wallet-fix.js?v=20260913-2';s.defer=true;document.head.appendChild(s)};
