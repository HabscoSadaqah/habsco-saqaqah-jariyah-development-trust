...
'use strict';
const css=`
.hf-pin-modal.hf-pin-final-layer{position:fixed!important;inset:0!important;width:100vw!important;height:100vh!important;z-index:2147483000!important;pointer-events:none!important;background:transparent!important;box-shadow:none!important;backdrop-filter:none!important;filter:none!important;overflow:hidden!important}
.hf-pin-modal.hf-pin-final-layer .hf-pin-backdrop{position:fixed!important;z-index:0!important;pointer-events:auto!important;background:rgba(2,18,11,.48)!important;backdrop-filter:blur(5px)!important;box-shadow:none!important;filter:none!important;border-radius:22px!important}
.hf-pin-modal.hf-pin-final-layer .hf-pin-sheet{position:fixed!important;z-index:2!important;pointer-events:auto!important;left:50%!important;top:50%!important;right:auto!important;bottom:auto!important;transform:translate(-50%,-50%)!important;margin:0!important;width:min(300px,calc(100vw - 56px))!important;max-width:calc(100vw - 56px)!important;max-height:calc(100vh - 56px)!important;box-sizing:border-box!important;overflow:auto!important;padding:18px!important;border-radius:18px!important;background:#fff!important;border:1px solid #dce9e2!important;box-shadow:0 20px 55px rgba(0,0,0,.28),0 5px 18px rgba(8,116,67,.12)!important;opacity:1!important;visibility:visible!important}
...
function position(){
 ...
 set(backdrop,{position:'fixed',left:rect.left+'px',top:rect.top+'px',width:rect.width+'px',height:rect.height+'px',right:'auto',bottom:'auto',zIndex:'0',pointerEvents:'auto',background:'rgba(2,18,11,.48)',backdropFilter:'blur(5px)',boxShadow:'none',filter:'none',borderRadius:'22px'});
