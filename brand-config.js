...
(function(){
  ...
  function setFooter(){
    ...
    if(!document.getElementById(styleId)){
      const style=document.createElement('style');style.id=styleId;style.textContent=`footer .footer-brand{display:flex;flex-direction:column;align-items:center;text-align:center;width:100%;padding:8px 10px 6px;box-sizing:border-box;gap:0;font-family:Inter,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",Arial,sans-serif}footer .footer-brand .habsco-footer-year{font-size:7px;line-height:1;font-weight:600;letter-spacing:.05em;color:#7a857f;margin-bottom:3px}footer .footer-brand .habsco-footer-wordmark{width:auto;box-sizing:border-box;text-align:center;font-size:16px;line-height:1;font-weight:950;letter-spacing:.16em;color:#063d26;text-transform:uppercase;white-space:nowrap;padding-left:.16em}footer .footer-brand .habsco-footer-tagline{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));width:min(210px,100%);box-sizing:border-box;margin-top:5px;font-size:6.5px;line-height:1;font-weight:800;letter-spacing:.02em;color:#087443;text-transform:uppercase}footer .footer-brand .habsco-footer-tagline span{display:flex;align-items:center;justify-content:center;min-width:0;height:15px;white-space:nowrap}footer .footer-brand .habsco-footer-tagline span+span{border-left:1px solid rgba(8,116,67,.18)}footer .footer-brand .habsco-footer-rights{font-size:7px;line-height:1;font-weight:500;color:#7a857f;margin-top:4px}@media(max-width:600px){footer .footer-brand{padding:7px 8px 5px}footer .footer-brand .habsco-footer-wordmark{font-size:14px;letter-spacing:.13em;padding-left:.13em}footer .footer-brand .habsco-footer-tagline{width:min(190px,100%);font-size:5.8px;margin-top:4px}footer .footer-brand .habsco-footer-tagline span{height:14px}footer .footer-brand .habsco-footer-year{font-size:6.5px;margin-bottom:2px}footer .footer-brand .habsco-footer-rights{font-size:6.3px;margin-top:3px}}@media(max-width:360px){footer .footer-brand .habsco-footer-wordmark{font-size:13px}footer .footer-brand .habsco-footer-tagline{font-size:5.5px}}`;document.head.appendChild(style);
    }
  }
