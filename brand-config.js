...
(function(){
  ...
  function setFooter(){
    ...
    if(!document.getElementById(styleId)){
      const style=document.createElement('style');style.id=styleId;style.textContent=`footer{display:block!important;visibility:visible!important;opacity:1!important;background:#fff!important;color:#063d26!important;box-shadow:none!important;border:0!important}footer .footer-brand{display:flex;flex-direction:column;align-items:center;text-align:center;width:100%;max-width:1180px;margin:0 auto;padding:13px 12px 11px;box-sizing:border-box;gap:0;background:transparent!important;border:0!important;border-radius:0!important;box-shadow:none!important;font-family:Inter,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",Arial,sans-serif}footer .footer-brand .habsco-footer-wordmark{font-size:14px;line-height:1.15;font-weight:750;letter-spacing:.085em;color:#063d26;text-transform:uppercase;white-space:nowrap;padding-left:.085em;font-family:Inter,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",Arial,sans-serif}footer .footer-brand .habsco-footer-tagline{display:flex;align-items:center;justify-content:center;gap:0;margin-top:7px;font-size:7px;line-height:1;font-weight:650;letter-spacing:.035em;color:#087443;text-transform:uppercase}footer .footer-brand .habsco-footer-tagline span{display:inline-block;white-space:nowrap;padding:0 8px}footer .footer-brand .habsco-footer-tagline span+span{border-left:1px solid #dfe6e2}footer .footer-brand .habsco-footer-rights{display:flex;flex-direction:row;flex-wrap:nowrap;align-items:center;justify-content:center;gap:5px;width:max-content;max-width:100%;white-space:nowrap;font-size:7px;line-height:1.15;color:#7a857f;margin-top:7px;font-weight:500;letter-spacing:.018em}footer .footer-brand .habsco-footer-rights span{display:inline-block;white-space:nowrap}footer .footer-brand .habsco-footer-rights span+span{color:#7a857f}@media(max-width:600px){footer .footer-brand{width:100%;margin-top:0;padding:11px 8px 9px}footer .footer-brand .habsco-footer-wordmark{font-size:13px;letter-spacing:.075em;padding-left:.075em}footer .footer-brand .habsco-footer-tagline{margin-top:6px;font-size:6.3px;letter-spacing:.025em}footer .footer-brand .habsco-footer-tagline span{padding:0 6px}footer .footer-brand .habsco-footer-rights{font-size:6.3px;margin-top:6px;gap:4px}}@media(max-width:360px){footer .footer-brand .habsco-footer-wordmark{font-size:12.5px}footer .footer-brand .habsco-footer-tagline{font-size:5.9px}footer .footer-brand .habsco-footer-tagline span{padding:0 5px}footer .footer-brand .habsco-footer-rights{font-size:5.9px;gap:3px}}`;document.head.appendChild(style);
    }
  }
