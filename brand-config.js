...
(function(){
  ...
  function setFooter(){
    ...
    if(!document.getElementById(styleId)){
      const style=document.createElement('style');style.id=styleId;style.textContent=`footer{display:block!important;visibility:visible!important;opacity:1!important;background:#fff!important;color:#063d26!important;box-shadow:none!important;border:0!important}footer .footer-brand{display:flex;flex-direction:column;align-items:center;text-align:center;width:100%;max-width:1180px;margin:0 auto;padding:10px 12px 8px;box-sizing:border-box;gap:0;background:transparent!important;border:0!important;border-radius:0!important;box-shadow:none!important;font-family:Inter,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",Arial,sans-serif}footer .footer-brand .habsco-footer-wordmark{font-size:13px;line-height:1.15;font-weight:750;letter-spacing:.09em;color:#063d26;text-transform:uppercase;white-space:nowrap;padding-left:.09em;font-family:Inter,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",Arial,sans-serif}footer .footer-brand .habsco-footer-tagline{display:flex;align-items:center;justify-content:center;gap:0;margin-top:6px;font-size:6.5px;line-height:1;font-weight:650;letter-spacing:.035em;color:#087443;text-transform:uppercase}footer .footer-brand .habsco-footer-tagline span{display:inline-block;white-space:nowrap;padding:0 8px}footer .footer-brand .habsco-footer-tagline span+span{border-left:1px solid #dfe6e2}footer .footer-brand .habsco-footer-rights{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:3px;font-size:6.5px;line-height:1.15;color:#7a857f;margin-top:6px;font-weight:500;letter-spacing:.02em}footer .footer-brand .habsco-footer-rights span{display:block;white-space:nowrap}@media(max-width:600px){footer .footer-brand{width:100%;margin-top:0;padding:9px 8px 7px}footer .footer-brand .habsco-footer-wordmark{font-size:12.5px;letter-spacing:.08em;padding-left:.08em}footer .footer-brand .habsco-footer-tagline{margin-top:5px;font-size:5.8px;letter-spacing:.025em}footer .footer-brand .habsco-footer-tagline span{padding:0 6px}footer .footer-brand .habsco-footer-rights{font-size:6px;margin-top:5px;gap:3px}}@media(max-width:360px){footer .footer-brand .habsco-footer-wordmark{font-size:12px}footer .footer-brand .habsco-footer-tagline{font-size:5.4px}footer .footer-brand .habsco-footer-tagline span{padding:0 5px}}`;document.head.appendChild(style);
    }
  }
