...
(function(){
  ...
  function setFooter(){
    ...
    const p=document.createElement('div');p.className='habsco-footer-tagline';p.setAttribute('aria-label','Business, Finance, Charity');p.innerHTML='<span>Business</span><span>Finance</span><span>Charity</span>';fb.appendChild(p);
