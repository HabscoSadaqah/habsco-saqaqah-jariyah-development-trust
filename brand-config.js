...
(function(){
  ...
  function setFooter(){
    ...
    if(!document.getElementById(styleId)){
      const style=document.createElement('style');style.id=styleId;style.textContent=`footer{display:block!important;visibility:visible!important;opacity:1!important;background:#fff!important;color:#063d26!important;box-shadow:none!important;border:0!important}footer .footer-brand{display:flex;flex-direction:column;align-items:center;text-align:center;width:calc(100% - 24px);max-width:1180px;margin:8px auto 0;padding:11px 14px 10px;box-sizing:border-box;gap:0;background:#fff!important;border:1px solid #e7ece9;border-radius:14px;box-shadow:0 1px 4px rgba(6,61,38,.035);font-family:Inter,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",Arial,sans-serif}footer .footer-brand .habsco-footer-wordmark{font-size:14px;line-height:1;font-weight:900;letter-spacing:.18em;color:#063d26;text-transform:uppercase;white-space:nowrap;padding-left:.18em}footer .footer-brand .habsco-footer-tagline{display:flex;align-items:center;justify-content:center;gap:0;margin-top:6px;font-size:6.5px;line-height:1;font-weight:700;letter-spacing:.035em;color:#087443;text-transform:uppercase}footer .footer-brand .habsco-footer-tagline span{display:inline-block;white-space:nowrap;padding:0 8px}footer .footer-brand .habsco-footer-tagline span+span{border-left:1px solid #dfe6e2}footer .footer-brand .habsco-footer-rights{font-size:6.5px;line-height:1;color:#7a857f;margin-top:5px;font-weight:500}@media(max-width:600px){footer .footer-brand{width:calc(100% - 16px);margin-top:6px;padding:9px 8px 8px;border-radius:12px}footer .footer-brand .habsco-footer-wordmark{font-size:13px;letter-spacing:.15em;padding-left:.15em}footer .footer-brand .habsco-footer-tagline{margin-top:5px;font-size:5.8px;letter-spacing:.025em}footer .footer-brand .habsco-footer-tagline span{padding:0 6px}footer .footer-brand .habsco-footer-rights{font-size:6px;margin-top:4px}}@media(max-width:360px){footer .footer-brand .habsco-footer-wordmark{font-size:12px}footer .footer-brand .habsco-footer-tagline{font-size:5.4px}footer .footer-brand .habsco-footer-tagline span{padding:0 5px}}`;document.head.appendChild(style);
    }
  }
